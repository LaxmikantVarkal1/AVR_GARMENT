...
import { Code, File, FileArchive, FileLock } from 'lucide-react';
...
const DEFAULT_ITEMS = [
  ...
  },
  {
    ...
    id: 2,
    icon: <FileLock className="h-[16px] w-[16px] text-white" />
  },
  {
    title: 'Components',
    description: 'Reusable components for your projects.',
    id: 3,
    icon: <FileArchive className="h-[16px] w-[16px] text-white" />
  },
  {
    title: 'Backgrounds',
